...
class Coucine(models.Model):
    ...
    continent = models.CharField('Continent', max_length=2, choices=CONTINENT_CHOICES, help_text='Continent where this coucine belongs to')
    name = models.CharField('Name', max_length=255, help_text='Name of the coucine')


class Recipe(models.Model):
    coucine = models.ForeignKey(Coucine)
